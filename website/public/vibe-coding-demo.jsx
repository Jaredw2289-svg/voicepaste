...
/* ── Icons ── */
function StarburstIcon({ size = 24, color = "#d97757" }) {
  return (
...
function SquiggleLine({ width = 200, color = "#d97757", style = {} }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 1 }}>
          ...
          {codeVisible && (
            <div style={{
              padding: "4px 14px", borderRadius: "6px 6px 0 0", fontSize: 11, fontWeight: 500,
              fontFamily: "'Poppins', sans-serif", background: "#252520", color: "#64635c",
      ...
      <div style={{ flex: 1, display: "flex", minHeight: 0 }}>
        ...
        <div style={{
          ...
          {terminalLines.map((line, i) => (
            <div key={`${i}-${line.slice(0, 10)}`} style={{
              ...
              color: termColor(line), whiteSpace: "pre-wrap",
        ...
        {codeVisible && (
          <div style={{ flex: 1, padding: "16px 18px", overflow: "auto", animation: "slideIn 0.5s ease" }}>
            <div style={{
              fontSize: 10.5, color: "#64635c", fontFamily: "'IBM Plex Mono', monospace",
            ...
            {scenario.codeLines.slice(0, codeLinesCount).map((line, i) => (
              <div key={i} style={{
                ...
                <span style={{ color: "#3a3a36", width: 22, textAlign: "right", flexShrink: 0, userSelect: "none", fontSize: 10.5 }}>{i + 1}</span>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 10, color: "#3a3a36", fontFamily: "'IBM Plex Mono', monospace" }}>claude-code v1.2</span>
      </div>
    </div>
  );
}
...
function FlowSteps({ phase }) {
  ...
  const all = ["idle", "hotkey", "listening", "processing", "sending", "coding", "done"];
  const pi = all.indexOf(phase);

  return (
    <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
      {steps.map((step, i) => {
        const sS = all.indexOf(step.phases[0]);
        const sE = all.indexOf(step.phases[step.phases.length - 1]);
          ...
          <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 5 }}>
              ...
              <span style={{
                ...
                fontFamily: "'Poppins', sans-serif", transition: "all 0.35s",
              }}>{step.label}</span>
            </div>
          </div>
        );
...
export default function VibeCodingDemo() {
  ...
  return (
    <div style={{
      width: "100%", aspectRatio: "16 / 9", maxHeight: "100vh",
      background: "#F5F5F0", position: "relative", overflow: "hidden",
      fontFamily: "'Lora', 'Georgia', serif", color: "#141413",
      display: "flex", flexDirection: "column",
    }}>
      <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 14, fontWeight: 500, color: "#141413", fontFamily: "'Lora', serif" }}>
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Poppins:wght@400;500;600;700&family=IBM+Plex+Mono:ital,wght@0,400;0,500;0,600;1,400&display=swap');
        @keyframes organicWave { 0% { height: 3px; } 50% { height: 18px; } 100% { height: 5px; } }
        @keyframes blink { 0%, 100% { opacity: 1; } 50% { opacity: 0; } }
        @keyframes pulse { 0%, 100% { opacity: 1; } 50% { opacity: 0.35; } }
        @keyframes termIn { from { opacity: 0; transform: translateY(4px); } to { opacity: 1; transform: translateY(0); } }
        @keyframes codeIn { from { opacity: 0; transform: translateX(-4px); } to { opacity: 1; transform: translateX(0); } }
